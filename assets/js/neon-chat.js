...
;(function($, window, undefined)
{
	...
	$.extend(neonChat, {	
		...
		open: function($user_link)
		{
			...
			// preserve any opened user to re-open after refreshing chat area by ajax call
			//alert(this.$current_user.attr('id'));
		},
		...
		//	});
			$conversation_window.show();
			$conversation_window.show().css({top: offset, opacity: 1});
