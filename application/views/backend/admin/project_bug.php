                        ...
                        <tr>
                            ...
                            <td style="width: 20%">
                                ...
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="confirm_modal('<?php echo base_url(); ?>index.php?admin/project_bug/delete/<?php echo $row1['project_bug_id']; ?>', '<?php echo base_url(); ?>index.php?admin/reload_projectroom_bug/<?php echo $project_code; ?>');">
