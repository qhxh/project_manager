            ...
            <tr class="odd gradeX">
                ...
                <td>
                    ...
                    <a class="tooltip-default" style="color:#aaa;" data-toggle="tooltip" 
                       ...
                       href="<?php echo base_url(); ?>index.php?admin/project_file/download/<?php echo $row1['project_file_id']; ?>">
                    ...
                    <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                       ...
                       onclick="confirm_modal('<?php echo base_url(); ?>index.php?admin/project_file/delete/<?php echo $row1['project_file_id']; ?>', '<?php echo base_url(); ?>index.php?admin/reload_projectroom_file_list/<?php echo $project_code; ?>');">
