			...
			<td>
            	<div class="btn-group">
                  ...
                  <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                    ...
                    <!-- DELETION LINK -->
                    <li>
                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/company/delete/<?php echo $row['company_id'];?>' , '<?php echo base_url();?>index.php?admin/reload_company_list');" >
