			...
			<td>
            	<div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <!-- DELETION LINK -->
                        <li>
                            <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/accounting_expense_category/delete/<?php echo $row['expense_category_id'];?>' , '<?php echo base_url();?>index.php?admin/reload_expense_category_list');" >
