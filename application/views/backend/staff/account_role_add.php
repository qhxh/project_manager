	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?staff/account_role/create/' , array('class' => 'form-horizontal form-groups validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
