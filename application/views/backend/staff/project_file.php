			...
			<div class="panel-body">
                ...
                <br>
                    ...
                    <div class="tab-pane" id="profile">
                        ...
                        <?php
                        echo form_open(base_url() . 'index.php?staff/project_file/dropzone_upload/' . $row['project_code'], array('class' => 'form-horizontal form-groups-bordered validate validate project-file-multiple-add',
                            'enctype' => 'mutipart/form-data'));
                        ?>
                        <div class="form-group">
