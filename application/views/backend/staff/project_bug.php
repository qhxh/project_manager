                        ...
                        <tr>
                            ...
                            <td style="width: 20%">
                                ...
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="confirm_modal('<?php echo base_url(); ?>index.php?staff/project_bug/delete/<?php echo $row1['project_bug_id']; ?>', '<?php echo base_url(); ?>index.php?staff/reload_projectroom_bug/<?php echo $project_code; ?>');">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-8 panel-title">
                        <i class="entypo-users"></i> <?php echo get_phrase('Assigned_Staff') ?>
                    </div>
