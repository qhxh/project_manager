			...
			<td>
            	<div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <!-- DELETION LINK -->
                        <li>
                            <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?staff/accounting_expense/delete/<?php echo $row['payment_id'];?>' , '<?php echo base_url();?>index.php?staff/reload_expense_list');" >
