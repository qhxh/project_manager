			...
			<td>
            	<div class="btn-group">
                  ...
                  <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                      ...
                      <!-- DELETION LINK -->
                      <li>
                          <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?staff/account_role/delete/<?php echo $row['account_role_id'];?>' , '<?php echo base_url();?>index.php?staff/reload_account_role_list');" >
