...
<?php echo form_open(base_url() . 'index.php?staff/project_note/save/' . $row['project_code'] , array(
...
<script>
    ...
    var post_refresh_url    =   '<?php echo base_url();?>index.php?staff/reload_projectroom_note/<?php echo $project_code;?>';
</script>
