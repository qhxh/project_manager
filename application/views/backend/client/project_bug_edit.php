    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?client/project_bug/edit/' . $param2, array(
...
<script>
    ...
    var post_refresh_url = '<?php echo base_url(); ?>index.php?client/reload_projectroom_bug/<?php echo $project_code; ?>';
</script>
